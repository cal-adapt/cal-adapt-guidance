...
![](figures/static/cal-adapt-operational-diagram.png){fig-alt="Diagram of Cal-Adapt's operational architecture, showing how weather, historical, and projections data flow into the Cal-Adapt database and are served to users through the Data Explorer and Analytics Engine."}
