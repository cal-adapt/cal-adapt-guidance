...
![Map of San Francisco showing a single climate model grid cell overlapping seven census tracts.](figures/static/census_tract_fig1.png)
:::
:::
...
:::
::: {.content-visible when-format="pdf"}
![Map of a large rural census tract in eastern Fresno County spanning multiple climate model grid cells across the Sierra Nevada foothills.](figures/static/census_tract_fig2.png)
:::
:::
