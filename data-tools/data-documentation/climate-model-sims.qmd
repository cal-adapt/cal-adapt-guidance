...
![](../figures/static/tbl-loca2-availability.png){fig-alt="Table of LOCA2-Hybrid data availability by variable group and scenario, colored by scenario."}
:::
...
:::
::: {.content-visible when-format="pdf"}
![](../figures/static/tbl-wrf-projections.png){fig-alt="Table of the number of WRF projection simulations available by scenario and spatial resolution, colored by scenario."}
:::
Number of WRF projection simulations available by scenario and spatial resolution, colored by scenario.
:::

\* Additional simulations from CESM2 for SSP2-4.5 and SSP5-8.5 at 9 km resolution are part of the larger suite of dynamically downscaled GCMs by UCLA, of which the CEC-supported simulations are a subset; see [more information here](https://atmos.ucla.edu/alexhall/cmip6-downscaling-using-wrf/).
...
```
![](../figures/static/warming_trajectory_2degC.png){.d-md-none fig-alt="Chart of the best estimate and 90 percent confidence interval for the year the world reaches 2.0°C of warming under the SSP3-7.0 scenario."}
:::
::: {.content-visible when-format="pdf"}
![](../figures/static/warming_trajectory_2degC.png){fig-alt="Chart of the best estimate and 90 percent confidence interval for the year the world reaches 2.0°C of warming under the SSP3-7.0 scenario."}
:::
...
:::
::: {.content-visible when-format="pdf"}
![](../figures/static/tbl-gwl-year-exceedance.png){fig-alt="Table of the best estimate and 90% likely range for the year each SSP scenario reaches a given global warming level, colored by scenario."}
:::
