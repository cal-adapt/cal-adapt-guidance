...
- For each application (with the relevant people) develop a list of detailed data needs including at the minimum:
  ...
  - [Historical](https://apps.epri.com/climate-data-user-guide/en/choosing-climate-projections.html) scenarios
  - [Future](https://apps.epri.com/climate-data-user-guide/en/choosing-climate-projections.html) scenarios
  - Preference for [downscaling](https://apps.epri.com/climate-data-user-guide/en/climate-model-downscaling.html) or [bias-adjustment](https://analytics.cal-adapt.org/glossary/index.html#bias-correction) approach (if any)
