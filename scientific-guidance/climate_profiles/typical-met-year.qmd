...
![CDF of long-term climatological daily max air temperature from 4 bias-adjusted WRF models at Los Angeles International Airport, 1990–2020.](figures/static/tmy_cdf_annual.png)
:::
...
```
::: {.content-visible when-format="pdf"}
![CDF of candidate month daily max air temperature from 4 bias-adjusted WRF models at Los Angeles International Airport for every year-month combination in 2015.](figures/static/tmy_cdf_mon_yr_grouped.png)
:::
...
:::
::: {.content-visible when-format="pdf"}
![Historical TMY hourly profile for Los Angeles International Airport for the 2038–2068 period, from MPI-ESM1-2-HR, shown across all weather variables.](figures/static/tmy_8760_by_variable.png)
:::
