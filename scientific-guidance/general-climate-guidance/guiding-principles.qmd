...
## Summary of Principles (Short Version)
...
::: {#box-1 .callout-warning icon=false title="Box 1: Choosing Variables and/or Metrics"}
...
::: {#box-2 .callout-warning icon=false title="Box 2: Selecting Appropriate Spatial & Temporal Scales"}
...
::: {#box-3 .callout-warning icon=false title="Box 3: Analyzing Data Size Trade-offs"}
...
::: {#box-4 .callout-warning icon=false title="Box 4: Aggregation Across Spatial and Temporal Scales"}
...
::: {#box-5 .callout-warning icon=false title="Box 5: Computing Change Signals"}
