...
![](figures/static/fig_return_period_by_gwl_plotly.png){fig-alt="Bar chart of return period for extreme heat days without nighttime reprieve in Sacramento County under three warming levels."}
:::
Return period of extreme heat days without nighttime reprieve in Sacramento County under three warming levels. A shorter return period means the event becomes more frequent. Data: WRF UCLA 3 km, SSP3-7.0.
:::
...
```
*Surge in heat-related emergency room visits during the 2020 heat wave. [Credit: SOURCE — update when image is added.]*
...
<div style="display:flex; gap:1.25rem; margin:1.5rem 0; align-items:stretch;">
  ...
  <div style="flex:1; border:1px solid #dee2e6; border-radius:0.375rem; overflow:hidden; display:flex; flex-direction:column;">
    ...
    <div style="padding:1rem; flex:1;">
      ...
      <p style="margin-top:0.5rem; font-size:0.9rem;">Trees shade pavement, reduce surface temperatures, and cool the air through evapotranspiration. Research consistently shows a 10% increase in urban canopy cover can lower mean summer temperatures by 1–2°F in dense, paved environments — with larger effects in low-canopy neighborhoods where the urban heat island is most intense. Sacramento is already investing heavily here — see Urban Tree Canopy Expansion below.</p>
    </div>
  </div>
  ...
  <div style="flex:1; border:1px solid #dee2e6; border-radius:0.375rem; overflow:hidden; display:flex; flex-direction:column;">
    ...
    <div style="padding:1rem; flex:1;">
      ...
      <p style="margin-top:0.5rem; font-size:0.9rem;">Shaded pedestrian and transit routes connecting cooling centers, parks, and public facilities reduce heat exposure for people traveling on foot. Cool corridors are especially effective for outdoor workers, elderly residents, and those without access to personal vehicles — populations that face the greatest risk during extreme heat events. Sacramento's new shaded bus shelters are a concrete example — see SacRT Heat-Resilient Bus Shelters below.</p>
    </div>
  </div>
  ...
  <div style="flex:1; border:1px solid #dee2e6; border-radius:0.375rem; overflow:hidden; display:flex; flex-direction:column;">
    ...
    <div style="padding:1rem; flex:1;">
      ...
      <p style="margin-top:0.5rem; font-size:0.9rem;">Air-conditioned public spaces — libraries, community centers, senior facilities — give people without reliable home cooling somewhere safe to go during the most dangerous heat events. Unlike shade or vegetation, refuge spaces don't lower ambient temperature, but they're often the difference between heat illness and safety for the most vulnerable residents. Sacramento already operates a countywide network — see Cooling Centers Network below.</p>
    </div>
  </div>
...
<div style="display:flex; gap:1.25rem; margin:1.5rem 0; align-items:stretch;">
  ...
  <div style="flex:1; border:1px solid #dee2e6; border-radius:0.375rem; overflow:hidden; display:flex; flex-direction:column;">
    ...
    <div style="padding:1rem; flex:1;">
      ...
      <p style="margin-top:0.5rem; font-size:0.9rem;">Through NeighborWoods and the City's Urban Forest Plan, Sacramento has planted roughly 1.5 million trees county-wide over its history, including 13,000+ shade trees and 6,000+ residents engaged in FY2024 alone, working toward the city's target of 25,000 trees planted per year. <a href="https://www.sciencedirect.com/science/article/abs/pii/S1618866723003631">Cooling-effectiveness research</a> consistently finds tree canopy cover outperforms building shading and pervious surfaces for mitigating human heat stress, with realistic air-temperature reductions of 1–3°C (more for direct surface/pavement shading) — making this the intervention with the broadest, most continuous reach county-wide.</p>
    </div>
  </div>
  ...
  <div style="flex:1; border:1px solid #dee2e6; border-radius:0.375rem; overflow:hidden; display:flex; flex-direction:column;">
    ...
    <div style="padding:1rem; flex:1;">
      ...
      <p style="margin-top:0.5rem; font-size:0.9rem;">Sacramento County operates a network of publicly accessible <a href="https://www.saccounty.gov/news/latest-news/Pages/Keep-Cool.-Cooling-Centers.aspx">cooling centers</a> — libraries, community centers, and senior facilities — that activate in step with the National Weather Service's HeatRisk Red/Magenta forecast levels. During the 2020 heat waves, the county activated more than 20 sites across the region. Reach is narrower than canopy cover since it only serves people during an active emergency, but for unhoused residents and those without AC or transportation, it's often the difference between heat illness and safety.</p>
    </div>
  </div>
  ...
  <div style="flex:1; border:1px solid #dee2e6; border-radius:0.375rem; overflow:hidden; display:flex; flex-direction:column;">
    ...
    <div style="padding:1rem; flex:1;">
      ...
      <p style="margin-top:0.5rem; font-size:0.9rem;">Sacramento Regional Transit was <a href="https://www.masstransitmag.com/technology/facilities/shelters-benches-and-equipment/article/55242936/california-governors-office-of-land-use-and-climate-innovation-selects-sacrt-for-extreme-heat-and-community-resilience-program-grant">awarded $449,900</a> to build up to 20 heat-resilient shelters at bus stops serving disadvantaged and low-income communities across the county, Citrus Heights, Folsom, Rancho Cordova, and Sacramento. It's a meaningful, targeted investment for the transit-dependent riders it reaches, but 20 shelters is a small fraction of the county's full bus-stop network — high equity relevance, smaller effect on county-wide heat exposure than canopy cover.</p>
    </div>
  </div>
