...
![Screenshot of the QGIS Data Source Manager Raster dialog configured to connect to the cadcat S3 bucket via the AWS S3 protocol.](figures/static/qgis_data_access1.png)
...
![Screenshot of the QGIS Select Items to Add dialog showing the TX99p variable with a shape of 5x472x223.](figures/static/qgis_data_access2.png)
