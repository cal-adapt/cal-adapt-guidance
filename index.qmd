...
::: {.lead .mobile-hero-subtitle .d-md-none}
The Cal-Adapt: Analytics Engine transforms the foundational climate and environmental data behind California’s Fifth Climate Change Assessment into actionable, expert-guided information to support informed decisions about resilience and planning.
:::
...
<div class="resource-explorer">
  ...
  <div class="resource-scroll-track" aria-hidden="true"><div class="resource-scroll-thumb"></div></div>
</div>
...
(function () {
  ...
  var track = document.querySelector('.resource-scroll-track');
  var thumb = document.querySelector('.resource-scroll-thumb');
  ...
  function updateScrollTrack() {
    ...
    var maxTranslate = track.clientWidth - thumb.clientWidth;
  ...
  carousel.addEventListener('scroll', updateScrollTrack);
...
<div class="partner-explorer">
  <div class="partner-carousel-wrap">
    ...
    <div class="partner-carousel" role="region" aria-label="Partner logos carousel">
      <a class="partner-logo-item" href="http://www.eaglerockanalytics.com/" target="_blank" rel="noopener noreferrer" aria-label="Eagle Rock Analytics"><img src="assets/logos/logo-era.png" alt="Eagle Rock Analytics"></a>
      <a class="partner-logo-item" href="https://www.energy.ca.gov/" target="_blank" rel="noopener noreferrer" aria-label="California Energy Commission"><img src="assets/logos/logo-cec.jpg" alt="California Energy Commission"></a>
      <a class="partner-logo-item" href="https://www.lbl.gov/" target="_blank" rel="noopener noreferrer" aria-label="Lawrence Berkeley National Lab"><img src="assets/logos/logo-lbnl.png" alt="Lawrence Berkeley National Lab"></a>
      <a class="partner-logo-item" href="http://gif.berkeley.edu/" target="_blank" rel="noopener noreferrer" aria-label="UC Berkeley Geospatial Innovation Facility"><img src="assets/logos/logo-gif.jpg" alt="UC Berkeley Geospatial Innovation Facility"></a>
      <a class="partner-logo-item" href="https://sig-gis.com/" target="_blank" rel="noopener noreferrer" aria-label="Spatial Informatics Group"><img src="assets/logos/logo-sig.svg" alt="Spatial Informatics Group"></a>
      <a class="partner-logo-item" href="https://www.ethree.com/" target="_blank" rel="noopener noreferrer" aria-label="Energy and Environmental Economics"><img src="assets/logos/logo-e3.png" alt="Energy and Environmental Economics"></a>
      <a class="partner-logo-item" href="https://www.ioes.ucla.edu/climate/" target="_blank" rel="noopener noreferrer" aria-label="UCLA Center for Climate Science"><img src="assets/logos/logo-ucla.jpg" alt="UCLA Center for Climate Science"></a>
      <a class="partner-logo-item" href="https://sustainability.aboutamazon.com/" target="_blank" rel="noopener noreferrer" aria-label="Amazon Sustainability"><img src="assets/logos/logo-amazon-sustainability.jpg" alt="Amazon Sustainability"></a>
    </div>
...
<div class="grid mt-3">
  ...
  <a href="about/our-project.html" class="info-card info-card-photo g-col-12 g-col-md-6">
    ...
    <div class="info-card-photo-body">
      ...
      <p>Supported by the California Energy Commission (EPC-20-007 and EPC-23-024) and Amazon Sustainability, ensuring public availability.</p>
    </div>
  </a>
