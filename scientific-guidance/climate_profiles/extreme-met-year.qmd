...
aliases:
  - /climate-profiles/extreme_meteorological_year_8760s
author:
  - name:
      literal: "Cal-Adapt"
date: "2024-06-26"
date-modified: &date-modified "2026-06-26"
subtitle: '[<i class="bi bi-box-arrow-up-right"></i> Read the white paper](https://analytics.cal-adapt.org/assets/pdfs/Cal-Adapt-XMY-Methods-White-Paper.pdf){target="_blank"}'
citation:
  publisher: "Cal-Adapt"
...
However, the general intent of an XMY is to select more extreme months (e.g., [@fordPreparing2026; @crawleyRethinking2015; @crawleyShould2019; @bassFuture2020; @zengReview2025]) instead of the median conditions represented in a TMY, and to use a large set of climate model simulations to do so. 
...
The Labor Day 2022 Heatwaves was one of the hottest on record for California, with Sacramento reaching 116°F (46.7°C), its highest temperature ever, alongside record-breaking electricity demand of more than 52,000 MW.  
:::

::: {#fig-exec-summary-boxplots}
![](figures/static/exec-summary-boxplots.png){width=55% fig-alt="Boxplot comparing typical (TMY) and extreme heat (XMY) temperature distributions for Sacramento across sector-relevant planning horizons."}
...
::: {#fig-shock-timeseries}
![](figures/static/shock_timeseries.png){width=85% fig-alt="Timeseries comparing Hot and Cold Shock XMY profiles to the TMY profile for Sacramento Executive Airport at mid-century (2.0°C GWL), with simulated heatwaves and coldsnaps highlighted."}

(Top) Hot Shock XMY profile compared to the TMY for the Sacramento Executive Airport (Sacramento, CA), with simulated heatwaves and associated impacts highlighted via arrows as examples for stress testing at mid-century (2.0°C GWL). (Bottom) Cold Shock XMY profile compared to the TMY profile for Sacramento, CA, with simulated coldsnaps and associated impacts highlighted as arrows at mid-century (2.0°C GWL).
:::
...
::: {#fig-persistence-timeseries}
![](figures/static/persistence_timeseries.png){width=85% fig-alt="Timeseries comparing Hot (90th percentile) and Cold (10th percentile) Persistence XMY profiles to the TMY profile for Sacramento Executive Airport at mid-century (2.0°C GWL)."}

(Top) Hot Persistence XMY profile compared to the TMY profile for Sacramento Executive Airport (Sacramento, CA) at the 90th percentile extreme at mid-century (2.0°C GWL). (Bottom) Cold Persistence XMY profile compared to TMY for Sacramento, at the 10th percentile extreme at mid-century (2.0°C).
:::
...
::: {#fig-xmy-degree-day-comparison}
![](figures/static/xmy_degree_day_comparison.png){width=60% fig-alt="Scatter plot of projected cooling and heating degree day changes across Extreme Meteorological Year profiles compared to Typical Meteorological Year median conditions for Sacramento, at present-day and mid-century warming levels."}

Projected change in cooling and heating degree days between present-day (1.2°C GWL, open-faced circles) and mid-century (2.0°C, solid circles) across Extreme Meteorological Year climate profiles compared to Typical Meteorological Year median conditions for Sacramento, CA. Dashed cross-hatch lines intersect at the multi-model mean present-day TMY CDD/HDD point (CDD: 1721 degree days, HDD: 1850 degree days). All 4 a priori bias-adjusted dynamically-downscaled WRF models are provided for each profile.
:::
...
::: {#fig-use-case-labor-day-heatwave}
![](figures/static/use_case_labor-day-heatwave.png){width=85% fig-alt="Line chart comparing Typical Meteorological Year and Shock Extreme Meteorological Year temperature profiles for Sacramento during heatwave conditions at mid-century (2.0°C), referenced against the Labor Day 2022 Heatwave."}

Comparison of Typical Meteorological Year conditions to a Shock Extreme Meteorological Year profile for Sacramento, CA during heatwave conditions at mid-century (2.0°C). As a reference, the Labor Day 2022 Heatwave maximum temperature is provided as motivating context for preparing for realistic extreme conditions. The Labor Day 2022 Heatwave was one of the hottest on record for California, with Sacramento reaching 116°F (46.7°C) and record-breaking electricity demand of more than 52,000 MW. The Labor Day 2022 Heatwave is estimated to be a 1-in-450 year extreme heat event. 
:::
...
flowchart TD
    A["<i>Inputs</i>: Select <b>Location</b> + <b>Planning Horizon</b>"]
    B["Select Shock Extreme <b>Type</b>"]
    C["<b><span style='color:#0000cc'>Cold</span></b><br><span style='color:#000000'>Extreme</span>"]
    D["<b><span style='color:#cc0000'>Hot</span></b><br><span style='color:#000000'>Extreme</span>"]
    E["<span style='color:#000000'>Daily </span><b><span style='color:#0000cc'>Min</span></b><br><span style='color:#000000'>Temperature</span>"]
    F["<span style='color:#000000'>Daily </span><b><span style='color:#cc0000'>Max</span></b><br><span style='color:#000000'>Temperature</span>"]
    G["<b><span style='color:#0000cc'>Max Negative<br>Error</span></b>"]
    H["<b><span style='color:#cc0000'>Max Positive<br>Error</span></b>"]
    I["Compile Extreme Months into Annual Timeseries"]
    J["<i>Outputs</i>: <b>Shock XMY Profile</b>"]
    ...
    classDef default fill:#e0e0e0,stroke:#000000
...
Hourly air temperature is retrieved for the location and climatology selections as the determining environmental factor for extreme characterization. This differs from the TMY approach which includes 10 environmental metrics, including solar radiation and wind speed [@wilcoxUsers2008; @iso-hygrothermal2005]. Air temperature is then resampled to the corresponding extreme type. For a cold extreme profile, the data is resampled to daily minimum temperature. For hot extremes, the data is resampled to daily maximum temperature. Cal-Adapt uses a priori bias-adjusted dynamically downscaled WRF model outputs as the data foundation for TMY and XMY profiles.
...
flowchart TD
    A["<i>Inputs</i>: Select <b>Location</b> + <b>Planning Horizon</b>"]
    B["Select <b>Extreme Percentile</b>"]
    C["<i><span style='color:#000000'>Lower Percentiles</span></i><br><b><span style='color:#0000cc'>Cold</span></b><span style='color:#000000'> Extreme</span>"]
    D["<i><span style='color:#000000'>Upper Percentiles</span></i><br><b><span style='color:#cc0000'>Hot</span></b><span style='color:#000000'> Extreme</span>"]
    E["Hourly Temperature Distribution"]
    F["Compile Extreme Hours into Annual Timeseries"]
    G["<i>Outputs</i>: <b>Persistence XMY Profile</b>"]
...
Hourly air temperature is retrieved for the location and climatology selections as the determining environmental factor for extreme characterization. This differs from the TMY approach which includes 10 environmental metrics, including solar radiation and wind speed [@wilcoxUsers2008; @crawleyShould2019]. Based on industry user interviews, **extreme conditions are most commonly characterized by the temperature profile**, reflecting the critical role temperature plays in defining system stress. Cal-Adapt uses a priori bias-adjusted dynamically downscaled WRF model outputs as the data foundation for TMY and XMY profiles.
