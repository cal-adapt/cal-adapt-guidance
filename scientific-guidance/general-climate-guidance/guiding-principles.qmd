...
::: {.blue-box}
[Principle 1: Scope and identify data needs]{.box-title}
...
::: {.blue-box}
[Principle 2: Catalog available data]{.box-title}
...
::: {.blue-box}
[Principle 3: Screen available datasets against requirements]{.box-title}
...
::: {.blue-box}
[Principle 4: Assess credibility of data]{.box-title}
...
::: {.blue-box}
[Principle 5: Sub-select data]{.box-title}
...
::: {.blue-box}
[Principle 6: Analyze data and summarize results]{.box-title}
...
::: {.blue-box}
[Principle 7: Evaluate and document the analysis]{.box-title}
