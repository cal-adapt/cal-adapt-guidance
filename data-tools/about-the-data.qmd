...
| SSP Scenario | 1.5°C | 2.0°C | 2.5°C | 3.0°C |
|---|---|---|---|---|
...
: Best estimate (with 90% very likely range in parentheses) for the year each SSP scenario reaches a given global warming level. Summarized from data from the IPCC. {#tbl-gwl-year-exceedance .striped}
...
### LOCA2-Hybrid precipitation output is too low

More information on this issue is in development. 
