...
![](figures/static/eva_figure1_gev_distribution.png){fig-alt="GEV distribution fitted to an annual maximum series of daily maximum air temperature."}

![](figures/static/eva_figure1_cdf.png){fig-alt="CDF plot showing a return probability of 0.2 for a return value of 115°F."}
...
![](figures/static/eva_figure2_ppf.png){width=70% fig-alt="PPF plot showing a return value of 115°F for a return probability of 0.2."}
