...
```
![](../figures/static/warming_trajectory_2degC.png){.d-md-none fig-alt="Chart of the best estimate and 90% confidence interval for the year the world reaches 2.0°C of warming under the SSP3-7.0 scenario."}
:::
::: {.content-visible when-format="pdf"}
![](../figures/static/warming_trajectory_2degC.png){fig-alt="Chart of the best estimate and 90% confidence interval for the year the world reaches 2.0°C of warming under the SSP3-7.0 scenario."}
:::
