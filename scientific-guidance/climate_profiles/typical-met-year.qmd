...
::: {#fig-tmy-cdf-annual}
```{=html}
<iframe src="figures/html/tmy_cdf_annual.html" width="100%" height="500px" frameborder="0" title="CDF of long-term climatological daily max air temperature from 4 bias-adjusted WRF models at Los Angeles International Airport, 1990–2020."></iframe>
```
...
```{=html}
<iframe src="figures/html/tmy_cdf_mon_yr_grouped.html" width="100%" height="500px" frameborder="0" title="CDF of candidate month daily max air temperature from 4 bias-adjusted WRF models at Los Angeles International Airport for every year-month combination in 2015."></iframe>
```
::: {.content-visible when-format="pdf"}
...
```{=html}
<iframe src="figures/html/tmy_8760_by_variable.html" width="100%" height="900px" frameborder="0" title="Historical TMY hourly profile for Los Angeles International Airport for the 2038–2068 period, from MPI-ESM1-2-HR, shown across all weather variables."></iframe>
```
:::
::: {.content-visible when-format="pdf"}
