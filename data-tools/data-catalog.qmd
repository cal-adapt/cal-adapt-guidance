...
- Get direct links to the underlying Zarr and NetCDF stores referenced by [Data Access Methods](access-methods.qmd)
...
### WRF
![](figures/static/wrf_t2_d03_2030.gif){.dataset-thumb fig-alt="Animated map of WRF-simulated 2m air temperature at 3km resolution over California for 2030."}
...
### LOCA2
![](figures/static/loca2_tasmax_2030.gif){.dataset-thumb fig-alt="Animated map of LOCA2 downscaled maximum air temperature over California for 2030."}
...
## Climate Profiles
![](figures/static/tmy_icon.png){.dataset-thumb fig-alt="Climate Profiles icon"}
...
![](figures/static/hdp_icon.png){.dataset-thumb fig-alt="Historic Weather Station Data icon"}
...
## Sea Level Rise
![](figures/static/sea_level_icon.png){.dataset-thumb fig-alt="Sea Level Rise icon"}
...
## Hydrologic Data
![](figures/static/hydrologic_icon.png){.dataset-thumb fig-alt="Hydrologic Data icon"}
...
![](figures/static/wind_cf_d03_2030.gif){.dataset-thumb fig-alt="Animated map of WRF-simulated wind capacity factor at 3km resolution over California for 2030."}
