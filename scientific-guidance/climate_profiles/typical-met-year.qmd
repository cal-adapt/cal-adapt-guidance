...
- Carefully consider whether a global warming level or a time-based approach for calculating a FTMY, especially with regards to projected climatic change over several decades [@laxoClimate2023; @sobieDataset2025]. Cal-Adapt recommends TMYs calculated using a [global warming levels](/general-climate-guidance/about-climate-projections.qmd#what-are-global-warming-levels) approach which ensures consistency between future climate projections and reduces uncertainties resulting from the wide range of climate sensitivity in climate models.
