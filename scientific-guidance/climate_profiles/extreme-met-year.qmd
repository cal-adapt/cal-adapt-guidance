...
However, the general intent of an XMY is to select more extreme months (e.g., [@crawleyRethinking2015; @crawleyShould2019; @bassFuture2020; @zengReview2025]) instead of the median conditions represented in a TMY, and to use a large set of climate model simulations to do so. 
