...
```{=static}
<iframe src="figures/static/xmy_degree_day_comparison.png" width="100%" height="500px" frameborder="0"></iframe>
```
::: {.content-visible when-format="pdf"}
![](figures/static/xmy_degree_day_comparison.png)
:::
Projected change in cooling and heating degree days between present-day (1.2°C GWL) and mid-century (2.0°C GWL) across XMY profiles compared to TMY conditions for Sacramento, CA. Open-faced circles represent present-day conditions, while solid circles indicate mid-century. 
:::
...
::: {#fig-xmy-shock-annual}
```{=html}
<iframe src="figures/html/xmy_shock_annual.png" width="100%" height="500px" frameborder="0"></iframe>
```
::: {.content-visible when-format="pdf"}
![](figures/static/xmy_shock_annual.png)
:::
This is a caption
:::
