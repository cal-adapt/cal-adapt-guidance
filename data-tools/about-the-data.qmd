...
: Comparison of the dynamically downscaled (WRF) and hybrid-statistically downscaled (LOCA2-Hybrid) data foundations. Other pre-aggregated daily and monthly datasets are also available; see the [Data Catalog](https://analytics.cal-adapt.org/data/catalog/) for the full listing. {#tbl-data-foundation .striped}
...
Not every model, ensemble member, or variable is available for every scenario. The tables below summarize what is available for each downscaling method; for the full, searchable listing of individual datasets, see the [Data Catalog](https://analytics.cal-adapt.org/data/catalog/).
...
![](figures/static/tbl-loca2-availability.png)
:::
...
:::
::: {.content-visible when-format="pdf"}
![](figures/static/tbl-wrf-projections.png)
:::
...
:::
::: {.content-visible when-format="pdf"}
![](figures/static/warming_trajectory_2degC.png)
:::
...
:::
::: {.content-visible when-format="pdf"}
![](figures/static/tbl-gwl-year-exceedance.png)
:::
...
The Analytics Engine team welcomes users to submit data for consideration for inclusion in the [Data Catalog](https://stac-browser.cal-adapt.org/). Users may also request the addition of external datasets to the platform for use in the cloud computing environment. These requests will be considered on a case-by-case basis depending on size, quality, and relationship to other funded work. All datasets must comply with CF conventions, as outlined in our [Metadata Standards](data-documentation/metadata-standards.qmd). Please submit requests via email to analytics@cal-adapt.org.
